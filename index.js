...
const scanForSpikes = async () => {
  ...
  try {
    ...
    console.log(`📡 Finnhub returned ${list.length} gainers`);
    for (const g of list) {
  ...
  } catch(e) { console.log("Finnhub gainers error:", e.message); }

  // Source 2: Pre‑market watchlist
